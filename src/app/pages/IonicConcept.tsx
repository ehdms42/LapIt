...
// Box: 왼쪽 컬러 보더가 있는 강조 박스 컴포넌트
// color: 보더 색상, bg: 배경 색상, title: 박스 상단 레이블
...
// Section: 번호 + 제목이 있는 섹션 컴포넌트
// num: 섹션 번호 (예: "1", "2"), title: 섹션 제목
